...
lib/src/waybright_bindings.dart: lib/src/native/xdg-shell-protocol.h lib/src/native/waybright.h
	dart run ffigen

clean:
	rm -rf lib/src/waybright_bindings.dart lib/src/native/xdg-shell-protocol.h build/
